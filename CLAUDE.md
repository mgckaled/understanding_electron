...
O diagnóstico completo — **119 entradas, da fundação ao arco atual** (93 ativas + 26 arquivadas, recontadas em 14/09/2026) — é dono de [`docs/ARMADILHAS.md`](docs/ARMADILHAS.md), com as da montagem inicial detalhadas em [`docs/study/04-diario-de-bordo.md`](docs/study/04-diario-de-bordo.md). Aqui fica só o conserto de um toque, para o erro que reaparece ao montar o ambiente:
