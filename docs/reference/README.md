...
| [Context7 — guia de implementação do arco 23](context7/README.md) | 06–07/09/2026 | ✅ vivo | **Substitui a Feature 2 do guia acima.** O material de entrada do arco 23, com as 32 decisões fechadas: por que o Context7 entra pela **REST** e não pelo MCP (DM-0, com o par de números que decidiu), a API sondada em 13 chamadas próprias, o desenho do painel estado por estado, e dez cortes com dependência declarada. Três anexos na pasta: [`api.md`](context7/api.md), [`decisoes.md`](context7/decisoes.md), [`painel.md`](context7/painel.md) |
