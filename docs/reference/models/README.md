...
⚠️ **Esta tabela data de 18/08/2026 e está incompleta** — `qwen3.5:2b` e `qwen3.5:4b` foram instalados fora do app depois dessa medição e adicionados pontualmente (R-6 e a sessão de 13/09/2026), porque são os dois mais usados. **O `/api/tags` local devolveu 13 entradas em 13/09/2026**, contra as 13 de 18/08 — o número bateu por coincidência, com composição diferente; os pesos dos demais **não** foram remedidos. Um reinventário completo da frota segue sendo trabalho separado, ainda não agendado.
