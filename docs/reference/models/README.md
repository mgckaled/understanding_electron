...
| [`cloud-optin.md`](cloud-optin.md) | Ficha técnica de seis candidatos de nuvem — dois de primeira parte (`gemini-2.5-flash`, `glm-4.7-flash`) e quatro elegíveis via provedor terceirizado (Kimi K2 e Qwen3 32B via Groq, DeepSeek-V3.2 via SambaNova, GPT-OSS-120B via Cerebras). Nenhum integrado; entra em uso quando a fatia 3 da [camada de IA](../../plan/active/09-camada-de-ia.md) (D15.9) sair do papel |
