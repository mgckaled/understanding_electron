...
- **DM-18 · DECIDIDA (07/09/2026) — `fast=false`** *(juízo)*. O gargalo do projeto é janela de contexto, não latência; ordenação melhor por alguns segundos é a troca certa. ⚠️ **Deixou de ser absoluta em 12/09/2026 — ver a linha de DM-18 em § *O que a execução fez*.**
