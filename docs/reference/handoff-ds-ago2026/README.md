...
**12/08/2026.** O que voltou da ferramenta externa de design, depois de curado. O que foi **pedido** a ela está em [`../brief-claude-design/README.md`](../brief-claude-design/README.md); o que se **decidiu** a partir do que voltou está em [`../../HISTORY-archive.md`](../../HISTORY-archive.md) § *Tailwind v4 entra* e nos planos da [trilha DS](../../plan/active/README.md#a-trilha-de-design-system-ds-n).
