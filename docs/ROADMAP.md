...
| Sexta fatia em `features/` | `eslint-plugin-boundaries` no lugar do `no-restricted-imports` | [`01-camadas`](plan/active/01-camadas-e-fronteiras.md) |
