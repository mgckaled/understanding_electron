...
Nenhum plano do arco em execução no momento — o 16 concluiu (movido para [`implemented/`](../implemented/16-anexo-mecanismo-e-dataset.md)) e o 17 ainda não foi escrito, por convenção (ver [§ O arco conversacional](#o-arco-conversacional-1320) abaixo).
