...
| # | Plano | Estado |
|---|---|---|
| [15](15-orcamento-de-contexto-e-modelo.md) | Orçamento de contexto e modelo por conversa | escrito, nenhum passo iniciado |
