...
O **arco 23** (documentação por Context7) abriu com [`23-A`](23-A-cliente-context7.md) — o cliente REST em `core/`, primeiro de dez cortes irmãos, sem subcorte. O material de entrada, com as 32 decisões fechadas, é [`reference/context7/`](../../reference/context7/README.md).
