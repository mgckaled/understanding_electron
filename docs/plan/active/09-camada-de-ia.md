...
> **Fatia 1 implementada em 2026-08-07** — o *gate* de disponibilidade, o provedor Ollama e o chat local em fluxo (a primeira linha da [ordem sugerida](#ordem-sugerida)). O documento **continua em `active/`** porque as fatias 5 (RAG) e 6 (ML) seguem no backlog — as fatias 2, 3 e 4 já foram absorvidas pelo arco (planos 19, N-1 e 16/18, respectivamente; ver [`plan/active/README.md § Fora do arco`](README.md#fora-do-arco-ainda-em-active)). A fatia 1 não precisou de camada de dados nem de pipeline de passos: sua única dependência real é o registro de jobs da [fase 06](../implemented/06-primeira-feature.md), como a própria [ordem sugerida](#ordem-sugerida) explicita.
>
