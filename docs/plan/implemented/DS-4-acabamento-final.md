...
|---|---|---|---|
| ago/2026 | — | Popover nativo (`popover="auto"` + CSS anchor positioning), tema manual sobre `nativeTheme` e acabamento. **Decisão revertida a pedido do usuário:** a versão anterior era "sem alternador de tema". | concluído |

**O que este plano deixou fora dele:**

| Achado | Dono |
|---|---|
| Um `className` no `Popover` derrota a regra de esconder do UA stylesheet | [`ARMADILHAS.md`](../../ARMADILHAS.md) § Arquivadas |
| jsdom esconde todo conteúdo de popover, não importa o estado | [`ARMADILHAS.md`](../../ARMADILHAS.md) |
| Tema por `nativeTheme.themeSource`, com `tokens.css` intocado | skill [`design-system`](../../../.claude/skills/design-system/SKILL.md) |
| Decisões DS4.1–DS4.2 | [`DECISOES.md`](../../DECISOES.md) |