...
- **DS7.7 — `advisor` chamado uma vez, antes de qualquer edição — suficiente aqui.** Diferente do DS-6 (que chamou duas vezes, achando deriva pós-portão-verde), este plano não tem passo de verificação ao vivo onde uma alegação sem prova poderia se esconder; o filtro inicial já cobriu radius, hover/seleção, o processo do Primer e a checagem factual do "corpo em 13px".
