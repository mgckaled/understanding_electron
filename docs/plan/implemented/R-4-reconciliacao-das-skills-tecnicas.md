...
- **Item 14** (link duplicado `[[ipc](../../../.claude/skills/ipc/SKILL.md)](../../../.claude/skills/ipc/SKILL.md)` na skill `comments`) — não existe no arquivo atual; dois greps independentes confirmam.
