...
/*
 * What a context window COSTS IN RAM, and therefore how large a one this
 * machine can afford (D15.2).
 *
 ...
 *
 * Split from `budget.ts` when the lock pushed that file past the ruler: this is
 * bytes, that is tokens, and the only thing crossing between them is a ceiling.
 */
