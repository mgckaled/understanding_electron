...
// blocked, invalidQuery and upstream carry their own text (D17.8; D18B.6 —
// the engine's own error, useful on its own in a diagnostic tool; upstream —
// describeUpstreamError already classifies it short and PT-BR, main-side) —
// the generic MESSAGES entry stays as the label for a bare AppError['kind'],
// but a real error of any of the three is strictly more informative than
// that fallback.
