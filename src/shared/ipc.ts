...
// The Context7 docs types (arco 23). They live here, not in core/context7/,
// because shared/ may import nothing but zod and IpcContract names them:
// what crosses the process boundary belongs here, while the wire shapes and
// the fetch seam stay next to the client that reads them (D23B.3).
